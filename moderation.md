...
This document codifies rules to resolve conflicts, spams and harassment among the contributors to Bitcoin Core.
...
As reminder, Bitcoin Core is a decentralized open-source project, as such there is no foundation
...
have direct short-term or long-term impact on the Bitcoin users funds.
...
We recognize 2 torts that are disruptive to the collaborative effort to Bitcoin Core.

Spamming: the fact of publishing comments or issues not directly related to the Bitcoin Core
...
Disclaimer: If you have been a contributor to the Bitcoin Core specification before XXX (TODO:
